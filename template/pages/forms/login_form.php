...
$hashedInputPassword = hash('sha1', $password);
  $sql = "SELECT * FROM `adminlogin` WHERE username='$username' and password='$hashedInputPassword'";
  
  $result=mysqli_query($con,$sql);
  if(mysqli_num_rows($result) > 0){
    $_SESSION['username']=$username;
    $_SESSION['password']=$hashedInputPassword;
