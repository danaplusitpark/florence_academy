                ...
                if($extension == 'jpg'||$extension == 'png'||$extension == 'gif'||$extension == 'jpeg' )
                  {        
                    if($fsize>=100000000)
                        ...
                        { 
                        $sql = "update social_media set media_img='$fnew' where id='$_GET[upd]' ";// store the submited data ino the database :images
                        ...
                        $success =  '<div class="alert alert-success alert-dismissible fade show" role="ale">
                              ...
                              header("Location: ../../pages/forms/social_media_update.php?updid=$idFromDB");
                              exit();
