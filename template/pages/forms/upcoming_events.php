         ...
         include '../connection/connection.php';
            ...
            if(isset($_POST['submit']))          
                { 
                  ...
                  $store = "../../uploads/upcoming_events/".basename($fnew);                    
                if($extension == 'jpg'||$extension == 'png'||$extension == 'gif'||$extension == 'jpeg' )
                  {        
                    if($fsize>=100000000)
                        ...
                        { 
                        $sql = "INSERT INTO upcoming_events (e_img,e_name,e_description) VALUE('".$fnew."', '".$name."' ,'".$description."')";// store the submited data ino the database :images
                          
                        mysqli_query($con, $sql); 
                        move_uploaded_file($temp, $store);
                        $success =  '<div class="alert alert-success alert-dismissible fade show" role="ale">
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                 Upcoming Events Added Successfully.
                              </div>';
            ...
            $sqlRead = "SELECT * FROM upcoming_events order by id desc";
    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            if (isset($_GET['success']) && $_GET['success'] == 1) {
              $successMessage = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
                                  Upcoming Events Deleted Successfully.
                                  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                  </div>';
              ...
              $successMessage = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
                                  Upcoming Events Updated Successfully.
                                  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                  </div>';
              // Display the success message
              echo $successMessage;
            ...
            ?>
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Upcoming events Form</h4>
                    ...
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleTextarea1" rows="4" name="description" placeholder="Write a Description"></textarea>
                      </div>
          ...
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Upcoming Events List </h3>
                      ...
                      <table class="table table-hover">
                        ...
                        if (!mysqli_num_rows($resultRead) > 0) 
                        {
                          ...
                          while ($rowDate = mysqli_fetch_array($resultRead)) 
                            ...
                            echo"<tr>";
                              echo"<td>".$i."</td>";
                              echo"<td>".$rowDate['e_name']."</td>";
                              echo"<td><img src='../../uploads/upcoming_events/" . htmlspecialchars($rowDate['e_img']) . "' style='width: 100px; height: 100px;''></td>";
                              echo"<td>".$rowDate['e_description']."</td>";
                              echo"<td>
                                <a class='btn btn-info btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;'  href='upcoming_events_update.php?event_upd=".$rowDate['id']."'><i class='fa fa-edit'></i></a>
                                <a class='btn btn-info btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;' href='upcoming_delete.php?event_dlt=".$rowDate['id']."'><i class='fa fa-trash'></i></a>
                              </td>";
                              echo"<td></td>";
                              echo"<td></td>";
                            echo"</tr>";
