                ...
                if($extension == 'jpg'||$extension == 'png'||$extension == 'gif'||$extension == 'jpeg' )
                  {        
                    if($fsize>=100000000)
                        ...
                        { 
                        $sql = "update banner_slider1 set s1_img='$fnew' where id='$_GET[upd]' ";// store the submited data ino the database :images
                        ...
                        move_uploaded_file($temp, $store);
                              ...
                              header("Location: ../../pages/forms/banner_slider1_update.php?upd=$idFromDB");
                              exit();
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Image Update Here</h4>
