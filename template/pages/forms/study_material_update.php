  ...
  <body>
    ...
    <?php
      ...
      if(isset($_POST['submit'])){
        $sql = "update study_material set study_material_heading ='$_POST[newheading]',price ='$_POST[newprice]' where id='$_GET[upd_id]' ";  // store the submited data ino the database :images                        
        mysqli_query($con, $sql); 
        $success =  '<div class="alert alert-success alert-dismissible fade show">
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                      <strong>Record Updated!</strong>.
                      </div>';
        header("Location: ../../pages/forms/study_materials.php");
          exit();
      }             
    ?> 
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php 
                        $ssql ="select * from study_material where id='$_GET[upd_id]'";
                        $res=mysqli_query($con, $ssql); 
                        $rowDate=mysqli_fetch_array($res);
                      ?>
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="exampleInputName1">Heading</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="newheading" value="<?php echo $rowDate['study_material_heading'] ?>">
                      </div>
                      
                      <div class="form-group">
                        <label>Image upload</label><br><br>
                        <img src="../../uploads/study_materials/<?php echo $rowDate['study_material_img'] ?> " style="width: 100px; height: 100px;">
                        <!-- <input type="file"  class="file-upload-default"> -->
                        <div class="input-group col-xs-12">

                          <!-- <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image"> -->
                          <span class="input-group-append">
                            <a class="file-upload-browse btn btn-info" type="button" style="width:100px;" href="<?php echo 'study_materials_img_update.php?upd_s_m='.$rowDate['id'].''?>">Edit</a>
                          </span>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Price" name="newprice" value="<?php echo $rowDate['price'] ?>">
                      </div>
                      <button type="submit" class="btn btn-info me-2" name="submit">Update</button>
