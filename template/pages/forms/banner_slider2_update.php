                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php
                        ...
                        $ssql ="select * from banner_slider2 where id='$_GET[upd]'";
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                          ...
                          <span class="input-group-append">
                            <a class="file-upload-browse btn btn-info" type="button" style="width:100px;" href="<?php echo 'banner_slider2_update_image.php?upd='.$rowDate['id'].''?>">Edit</a>
                          </span>
                        </div>
                      </div>
