    ...
    <?php
       include '../connection/connection.php';
           ...
           if (isset($_POST['submit'])) {
                ...
                $sql = "INSERT INTO news_slider (news_description) VALUES ('$description')";
                ...
                $sqlRead = "SELECT * FROM news_slider order by id desc";
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">NEWS SLIDER  </h3>
                              ...
                              while ($rowDate = mysqli_fetch_array($resultRead)) 
                                {
                                  echo"<tr>";
                                      echo"<td>".$i."</td>";
                                      echo"<td></td>";
                                      echo"<td>".$rowDate['news_description']."</td>";
                                      echo"<td></td>";
                                      echo"<td>
                                              <a class='btn btn-info btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;'  href='news_update.php?id=".$rowDate['id']."'><i class='fa fa-edit'></i></a>
                                              <a class='btn btn-info btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;' href='news_delete.php?id=".$rowDate['id']."'><i class='fa fa-trash'></i></a>
                                            </td>";
                                      echo"<td></td>";
                                      echo"<td></td>";
                                    echo"</tr>";
