        ...
        include '../connection/connection.php';
            ...
            if(isset($_POST['submit']))          
                {   
                  ...
                  $store = "../../uploads/ads/".basename($fnew);                    
                              ...
                              while ($rowDate = mysqli_fetch_array($resultRead)) 
                                {
                                  echo"<tr>";
                                    echo"<td>".$i."</td>";
                                    echo"<td></td>";
                                    echo"<td><img src='../../uploads/ads/" . htmlspecialchars($rowDate['ads_img']) . "' style='width: 100px; height: 100px;''></td>";
                                    echo"<td></td>";
                                    echo"<td>
                                          <a class='btn btn-info btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;'  href='ads_update.php?ads_upd_id=".$rowDate['id']."'><i class='fa fa-edit'></i></a>
                                          <a class='btn btn-info btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;' href='ads_image_delete.php?id=".$rowDate['id']."'><i class='fa fa-trash'></i></a>
                                        </td>";
                                    echo"<td></td>";
                                    echo"<td></td>";
                                  echo"</tr>";
