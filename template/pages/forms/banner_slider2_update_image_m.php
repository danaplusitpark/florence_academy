                ...
                if($extension == 'jpg'||$extension == 'png'||$extension == 'gif'||$extension == 'jpeg' )
                  {        
                    if($fsize>=100000000)
                        ...
                        { 
                        $sql = "update banner_slider2 set s2_img_moblie='$fnew' where id='$_GET[upd]' ";// store the submited data ino the database :images
                        ...
                        move_uploaded_file($temp, $store);
                              ...
                              header("Location: ../../pages/forms/slider2.php?msuccess=1");
                              exit();
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> BANNER SLIDER2  </h3>
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Mobile Update Here</h4>
