                ...
                if($extension == 'jpg'||$extension == 'png'||$extension == 'gif'||$extension == 'jpeg' )
                  {        
                    if($fsize>=100000000)
                        ...
                        { 
                        $sql = "update study_material set study_material_img ='$fnew' where id='$_GET[upd_s_m]' ";// store the submited data ino the database :images
                        ...
                        $success =  '<div class="alert alert-success alert-dismissible fade show" role="ale">
                              ...
                              $idFromDB = $_GET['upd_s_m']; // Assuming this is your actual id parameter

                              // Use the fetched id for redirection
                              header("Location: ../../pages/forms/study_material_update.php?upd_id=$idFromDB");
                              exit();
