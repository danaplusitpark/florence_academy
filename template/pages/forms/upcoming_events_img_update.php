                ...
                if($extension == 'jpg'||$extension == 'png'||$extension == 'gif'||$extension == 'jpeg' )
                  {        
                    if($fsize>=100000000)
                        ...
                        { 
                        $sql = "update upcoming_events set e_img ='$fnew' where id='$_GET[upd]' ";// store the submited data ino the database :images
                        ...
                        $success =  '<div class="alert alert-success alert-dismissible fade show" role="ale">
                              ...
                              header("Location: ../../pages/forms/upcoming_events_update.php?event_upd=$idFromDB");
                              exit();
