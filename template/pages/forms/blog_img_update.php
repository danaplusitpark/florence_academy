                ...
                if($extension == 'jpg'||$extension == 'png'||$extension == 'gif'||$extension == 'jpeg' )
                  {        
                    if($fsize>=100000000)
                        ...
                        { 
                        $sql = "update blog set b_img='$fnew' where id='$_GET[updb]' ";// store the submited data ino the database :images
                        ...
                        $success =  '<div class="alert alert-success alert-dismissible fade show" role="ale">
                              ...
                              header("Location: ../../pages/forms/blog_update.php?b_upd=$idFromDB");
                              exit();
