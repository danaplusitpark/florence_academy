  ...
  <body>
   ...
   <?php
      ...
      if(isset($_POST['submit']))        
        {
          $sql = "update blog set b_name ='$_POST[blogname]',b_description ='$_POST[blogdes]' where id='$_GET[b_upd]' ";  // store the submited data ino the database :images                        
          mysqli_query($con, $sql); 
          $success =  '<div class="alert alert-success alert-dismissible fade show">
                       <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <strong>Record Updated!</strong>.
                        </div>';
          header("Location: ../../pages/forms/blog.php?updsuccess=1");
           exit();
        }
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php 
                        $ssql ="select * from blog where id='$_GET[b_upd]'";
                    ...
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" value="<?php echo $rowDate['b_name'] ?>" name="blogname">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <img src="../../uploads/blog/<?php echo $rowDate['b_img'] ?> " style="width: 100px; height: 100px;">
                        <!-- <input type="file"  class="file-upload-default"> -->
                        <div class="input-group col-xs-12">

                          <!-- <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image"> -->
                          <span class="input-group-append">
                            <a class="file-upload-browse btn btn-info" type="button" style="width:100px;" href="<?php echo 'blog_img_update.php?updb='.$rowDate['id'].''?>">Edit</a>
                          </span>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleTextarea1" rows="4" placeholder="description here" name="blogdes"><?php echo $rowDate['b_description'] ?></textarea>
                      </div>
