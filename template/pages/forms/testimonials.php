                ...
                if($extension == 'jpg'||$extension == 'png'||$extension == 'gif'||$extension == 'jpeg' )
                  {        
                    if($fsize>=100000000)
                        ...
                        { 
                        $sql = "INSERT INTO silder1_desktop (s1_img) VALUE('".$fnew."')";// store the submited data ino the database :images
                      ...
                      <table class="table table-hover">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>1</td>
                            <td>Jacob Mathan</td>
                            <td>Had a good experience</td>
                            <td><img src="../../assets/images/auth/Login_bg2.jpg" style="width: 100px; height: 100px;"></td>
