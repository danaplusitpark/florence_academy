<?php
      ...
      if(isset($_POST['submit']))        
        {
          header("Location: ../../pages/forms/slider1.php?usuccess=1");
           exit();
        }           
    ?>
<!DOCTYPE html>
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Update Image Here</h4>
                    <!-- <p class="card-description"> Basic form elements </p> -->
                    <?php
                        include '../connection/connection.php'; 
                        $ssql ="select * from banner_slider1 where id='$_GET[upd]'";
                    ...
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <img src="../../uploads/banner_slider1/<?php echo $rowDate['s1_img'] ?> " style="width: 100px; height: 100px;">
                        <!-- <input type="file"  class="file-upload-default"> -->
                        <div class="input-group col-xs-12">

                          <!-- <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image"> -->
                          <span class="input-group-append">
                            <a class="file-upload-browse btn btn-info" type="button" style="width:100px;" href="<?php echo 'banner_slider1_update_image.php?upd='.$rowDate['id'].''?>">Edit</a>
                          </span>
                        </div>
                      </div>
                      <div class="form-group">
                        <label>Mobile Image Update</label><br><br>
                        <img src="../../uploads/banner_slider1/<?php echo $rowDate['s1_img_moblie'] ?> " style="width: 100px; height: 100px;">
                        <!-- <input type="file"  class="file-upload-default"> -->
                        <div class="input-group col-xs-12">

                          <!-- <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image"> -->
                          <span class="input-group-append">
                            <a class="file-upload-browse btn btn-info" type="button" style="width:100px;" href="<?php echo 'banner_slider1_update_image_m.php?upd='.$rowDate['id'].''?>">Edit</a>
                          </span>
                        </div>
                      </div>
