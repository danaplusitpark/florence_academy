     ...
     include '../connection/connection.php';
            ...
            if(isset($_POST['submit']))          
                { 
                  ...
                  $store = "../../uploads/banner_slider2/".basename($fnew);                    
                  ...
                  {        
                    if($fsize>=100000000)
                     ...
                     if(isset($_POST['submit']))          
                        ...
                        $moblie_store = "../../uploads/banner_slider2/".basename($moblie_fnew);                    
                        if($moblie_extension == 'jpg'||$moblie_extension == 'png'||$moblie_extension == 'gif'||$moblie_extension == 'jpeg' )
                          {        
                            if($moblie_fsize>=100000000)
                             ...
                             { 
                               $moblie_sql = "INSERT INTO banner_slider2 (s2_img,s2_img_moblie) VALUE('".$fnew."','".$moblie_fnew."')";// store the submited data ino the database :images 
          ...
          $sqlRead = "SELECT * FROM banner_slider2 order by id desc";
            $resultRead = $con->query($sqlRead);

            $sqlRead2 = "SELECT * FROM banner_slider2 order by id desc";
