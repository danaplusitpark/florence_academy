  ...
  <body>
   ...
   <?php
      ...
      if(isset($_POST['submit']))        
        {
          $sql = "update news_slider set  news_description ='$_POST[newdes]' where id='$_GET[id]' ";  // store the submited data ino the database :images                        
          mysqli_query($con, $sql); 
          $success =  '<div class="alert alert-success alert-dismissible fade show">
                       <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <strong>Record Updated!</strong>.
                        </div>';
          header("Location: ../../pages/forms/news_slider.php?updsuccess=1");
           exit();
        }
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Update Here</h4>
                    <!-- <p class="card-description"> Basic form elements </p> -->
                    <?php 
                        $ssql ="select * from news_slider where id='$_GET[id]'";
                    ...
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data"> 
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleTextarea1" rows="4" placeholder="description here" name="newdes"><?php echo $rowDate['news_description'] ?></textarea>
                      </div>
