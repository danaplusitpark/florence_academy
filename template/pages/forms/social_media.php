         ...
         include '../connection/connection.php';
            ...
            if(isset($_POST['submit']))          
                { 
                  ...
                  $store = "../../uploads/social_media/".basename($fnew);                    
                if($extension == 'jpg'||$extension == 'png'||$extension == 'gif'||$extension == 'jpeg' )
                  {        
                    if($fsize>=100000000)
                        ...
                        { 
                        $sql = "INSERT INTO social_media (media_img,media_name,media_description) VALUE('".$fnew."', '".$name."' ,'".$description."')";// store the submited data ino the database :images
            ...
            $sqlRead = "SELECT * FROM social_media order by id desc";
                      ...
                      <table class="table table-hover">
                        ...
                        if (!mysqli_num_rows($resultRead) > 0) 
                        {
                          ...
                          while ($rowDate = mysqli_fetch_array($resultRead)) 
                            ...
                            echo"<tr>";
                              echo"<td>".$i."</td>";
                              echo"<td>".$rowDate['media_name']."</td>";
                              echo"<td><img src='../../uploads/social_media/" . htmlspecialchars($rowDate['media_img']) . "' style='width: 100px; height: 100px;''></td>";
                              echo"<td>".$rowDate['media_description']."</td>";
                              echo"<td>
                                <a class='btn btn-info btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;'  href='social_media_update.php?updid=".$rowDate['id']."'><i class='fa fa-edit'></i></a>
                                <a class='btn btn-info btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;' href='social_media_delete.php?dltid=".$rowDate['id']."'><i class='fa fa-trash'></i></a>
                              </td>";
                              echo"<td></td>";
                              echo"<td></td>";
                            echo"</tr>";
