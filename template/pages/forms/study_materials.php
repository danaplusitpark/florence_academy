         ...
         include '../connection/connection.php';
            ...
            if(isset($_POST['submit']))          
                { 
                  ...
                  $store = "../../uploads/study_materials/".basename($fnew);                    
                if($extension == 'jpg'||$extension == 'png'||$extension == 'gif'||$extension == 'jpeg' )
                  {        
                    if($fsize>=100000000)
                        ...
                        { 
                        $sql = "INSERT INTO study_material (study_material_img,study_material_heading, price) VALUE('".$fnew."', '".$heading."' , '".$price."')";// store the submited data ino the database :images
            ...
            $sqlRead = "SELECT * FROM study_material order by id desc";
    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="heading">
                      </div>
          ...
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Social media List </h3>
                          ...
                          while ($rowDate = mysqli_fetch_array($resultRead)) 
                            {
                              echo"<tr>";
                                echo"<td>".$i."</td>";
                                echo"<td><img src='../../uploads/study_materials/" . htmlspecialchars($rowDate['study_material_img']) . "' style='width: 100px; height: 100px;''></td>";
                                echo"<td>".$rowDate['study_material_heading']."</td>";
                                echo"<td>Rs.".$rowDate['price']."</td>";
                                echo"<td>
                                <a class='btn btn-info btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;'  href='study_material_update.php?upd_id=".$rowDate['id']."'><i class='fa fa-edit'></i></a>
                                <a class='btn btn-info btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;' href='study_material_delete.php?id=".$rowDate['id']."'><i class='fa fa-trash'></i></a>
                                </td>";
                                echo"<td></td>";
                                echo"<td></td>";
                              echo"</tr>";
