        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> ADS_IMAGE </h3>  
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php
                        ...
                        $ssql ="select * from ads where id='$_GET[ads_upd_id]'";
                    ...
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <img src="../../uploads/ads/<?php echo $rowDate['ads_img'] ?> " style="width: 100px; height: 100px;">
                        <!-- <input type="file"  class="file-upload-default"> -->
                        <div class="input-group col-xs-12">

                          <!-- <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image"> -->
                          <span class="input-group-append">
                            <a class="file-upload-browse btn btn-info" type="button" style="width:100px;" href="<?php echo 'ads_image_update.php?upd='.$rowDate['id'].''?>">Edit</a>
                          </span>
                        </div>
                      </div>
