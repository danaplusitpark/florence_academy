                ...
                if($extension == 'jpg'||$extension == 'png'||$extension == 'gif'||$extension == 'jpeg' )
                  {        
                    if($fsize>=100000000)
                        ...
                        { 
                        $sql = "update ads set ads_img='$fnew' where id='$_GET[upd]' ";// store the submited data ino the database :images
                        ...
                        $success =  '<div class="alert alert-light alert-dismissible fade show" role="ale">
                              ...
                              header("Location: ../../pages/forms/ads_image.php?updsuccess=1");
                              exit();
